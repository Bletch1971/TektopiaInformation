		...
		if (entity instanceof EntityVillagerTek) {
			...
			if (villager != null) {
				...
				if (entity instanceof EntityArchitect) {
					// Profession
					String profession = TextUtils.translate("entity.architect.name");
					output = profession;
					...
					// Profession
					String profession = TextUtils.translate("entity.merchant.name");
					output = profession;
					currentTip.add(TextFormatting.DARK_AQUA + output);
				} 
				else if (entity instanceof EntityTradesman) {
					// Profession
					String profession = TextUtils.translate("entity.tradesman.name");
					output = profession;
					currentTip.add(TextFormatting.DARK_AQUA + output);
